...
for (const attr in student1_2) {
    console.log(attr);
    console.log(student1_2[attr]);
}
...
console.log(`\n\nStudent has 9 years of experience\n\n`);
for (const attr in student3_1) {
    console.log(student3_1.anyExperience);
    console.log(student3_1.pastJobs[0].companyName);
}
